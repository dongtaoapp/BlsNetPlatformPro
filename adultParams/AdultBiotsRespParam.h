...
namespace jysoft { namespace simulator { namespace resp {
	...
	/*-----------------------------------------------------------------------------------------------------------------
	类说明：     成人毕奥呼吸参数提供类；特点：间插不规则的周期性呼吸暂停打乱了呼吸的连续性
	创建人：	 hjg
	创建时间：   2017/2/22
	//-----------------------------------------------------------------------------------------------------------------*/

    class ADULTPARAMSSHARED_EXPORT CAdultBiotsRespParam
	{
	public:
		CAdultBiotsRespParam(void);
		virtual ~CAdultBiotsRespParam(void);
	public:
		//加载某呼吸速率的参数值
