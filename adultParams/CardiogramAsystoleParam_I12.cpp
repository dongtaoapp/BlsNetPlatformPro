...
namespace jysoft { namespace simulator { namespace ecg {
	...
	CCardiogramAsystoleParam_I12::CCardiogramAsystoleParam_I12( IStorage *pRootStorage )
						: CVirCardiogramParam()
	{
		m_pStorages = pRootStorage;
	}

	CCardiogramAsystoleParam_I12::~CCardiogramAsystoleParam_I12(void)
	{
	}

	//加载参数值
    void CCardiogramAsystoleParam_I12::LoadCardiogramParam(QRS eQRS, BasicRhythm eRhythm,int uHR, short sConduct/*=0*/, short sExtendParam/*=0*/)
	{
		//段名称；时间
		...
		{
			m_setParams["HR"] = boost::lexical_cast<std::string>(0);
