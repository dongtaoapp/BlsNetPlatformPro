...
namespace jysoft { namespace simulator { namespace resp {
	...
	/*-----------------------------------------------------------------------------------------------------------------
	类说明：     成人长呼吸参数提供类；特点：规则的周期性呼吸暂停中添加一次正常呼吸
	创建人：	 hjg
	创建时间：   2017/2/22
	//-----------------------------------------------------------------------------------------------------------------*/

    class ADULTPARAMSSHARED_EXPORT CAdultApneusticRespParam
	{
	public:
		CAdultApneusticRespParam(void);
		virtual ~CAdultApneusticRespParam(void);
	public:
		//加载某呼吸速率的参数值
