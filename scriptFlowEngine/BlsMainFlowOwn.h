...
{
	class CBlsMainFlowOwn : public CBlsMainFlowVirtual
	{
	public:
		CBlsMainFlowOwn(CBlsSimulateCase  *pSimulateCase, transLayer::CFormatTransport* pTransport);
		virtual ~CBlsMainFlowOwn(void);
	public: //基类重载
		/*******************************************************************************/
		// 函数名称： CreateScenario
